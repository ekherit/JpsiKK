...
#ifdef RootEmc_cxx
RootEmc::RootEmc(TTree *tree) : fChain(0) 
{
...
Int_t RootEmc::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t RootEmc::LoadTree(Long64_t entry)
{
...
void RootEmc::Show(Long64_t entry)
{
...
Int_t RootEmc::Cut(Long64_t entry)
{
