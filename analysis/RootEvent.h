...
// Wed Dec  2 18:36:53 2015 by ROOT version 6.04/10
// from TTree event/Signal events pi+pi- K+K-, or pi+pi- mu+mu-
// found on file: ../data/test_selections/testmcKKuu.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../data/test_selections/testmcKKuu.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../data/test_selections/testmcKKuu.root");
      }
